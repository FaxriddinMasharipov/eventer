...
\yii\grid\GridView::widget([
    ...
    'columns' => ['ids','sot','sotin',"kol_ost","kol_in_ost","nom" , "idt", "tkol_in"],]);
?>

<div class="buttons"><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Tovar nomi...">
...
<div  style="background-color: white; padding: 3px">
    <table border="1" style="padding: 5px"  id="myTable">
        ...
        <tr id=<?= $ite['ids'] ?>>
            <td><span class="tovar_nom<?=$ite['ids']?>"><?= $ite['nom']?>( <?= $ite['sot']?>
            <?php
            if($ite['tkol_in'] > 1){ ?>
                , 
                <?=$ite['sotin']?>
