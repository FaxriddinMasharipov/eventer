...
$dilernomi=Yii::$app->request->post('dilernomi');
?>
<div class="container mt-6">
	<a class=" btn btn-success" href="kirim"><span class="glyphicon glyphicon-arrow-left" ></span></a><br>
	<br>
     <div>
     <table>
        <tr>
            ...
            <td>
                <input type="text" class="center" name="nomer" class="form-control" value="<?=$nomer?>" disabled>
            </td>
            <td>
                Sana: 
            </td>
            <td> 
                <input type="text" class="center" name="sana" class="form-control" value="<?=$sana?>" disabled> 
            </td>
            <td>
                Mol yetkazuvchi: 
            </td>
            <td>
                <input type="text" class="center" name="diler" class="form-control" value="<?=$dilernomi?>" disabled>
            </td>   
        </tr>
     </table>
     </div>
...
<div  style="text-align: center;margin: 2px; background-color: rgba(43,106,246,0.77);">
    <table class="asoss table table-bordered">
        ...
        <?php
            ...
            ->where(['asos_id'=>$asosid,'s.del_flag'=>1])
            ->all();
